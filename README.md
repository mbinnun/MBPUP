...
-
*Resolution:* run **sudo rm /var/crash/\*** from the terminal and reload PcManFM. You're not supposed to experience another crash till the end of the session.<br />*Another option:* use **Nautilus** as you primary file manager

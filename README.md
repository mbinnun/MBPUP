...
-
**Resolution:**<br />run **sudo rm /var/crash/\*** from the terminal and reload PcManFM.<br />You're not supposed to experience another crash till the end of the session.<br /><br />**Another option:**<br />use *Nautilus* as you primary file manager.

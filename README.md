...
-
Resolution: run **sudo rm /var/crash/\*** from the terminal and reload PcManFM. You're not supposed to experience another crash till the end of the session.<br /><br />Another option is to use **Nautilus** as you primary file manager
